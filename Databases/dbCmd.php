...
// $sql = "ALTER TABLE pesanan CHANGE id_user id_pembeli INT NOT NULL"; // Sesuaikan tipe data sesuai kebutuhan
//     $sql = "ALTER TABLE pesanan ADD COLUMN nomor_antrian INT";
// if ($conn->query($sql) === TRUE) {
//     echo "Data berhasil ditambahkan. Nomor antrian anda adalah: ";
// } else {
